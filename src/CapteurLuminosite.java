...
public class CapteurLuminosite extends AbstractCapteur {

    private Random random;
    private double max;
    private double min;

    public CapteurLuminosite (String centraleAddr) throws Exception{
        //15 est la valeur de base
        //4000 est le sleep time
        super(centraleAddr, 27, 4000);
    ...
    protected double genererValeur() {
        //on regenre un sleepTime aleatoire
        this.sleepTime = 500 * random.nextInt(40);
